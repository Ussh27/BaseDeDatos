...
module.exports.crearUsuarioDemo = function(callback){ //Función para crear usuarios
  var arr = [{ email: 'demo@mail.com', user: "demo", password: "123456"}, { email: 'ussh@mail.com', user: "ussh", password: "123456"}]; //array con la información de los usuarios a insertar
  Usuario.insertMany(arr, function(error, docs) { //Utilizar la función insertMany para insertar varios registros en una sola consulta
    if (error){ //Acciones si existe un error
      ...
      callback(null, "El usuario 'demo' y 'ussh' se ha registrado correctamente. </br>usuario: demo | password:123456 </br >usuario: ussh | password:123456") //Mostrar mensaje del usuario guardado con exito
    }
  });
